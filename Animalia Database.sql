/*Build entire database and fill in, this is a stored procedure of all things for a database*/ 
/* after creating it you can remove this part
...
USE db_zoo
 /*ensrue everything is indented in the begin*/
	...
	INSERT INTO tbl_class /* Select the table you want */
			(class_type) /* the input in the table*/
				VALUES
				('bird'),
				('reptilian'),
				('mamal'),
	...
	SELECT * FROM	tbl_class;  /* the asterik means all*/
	...
	INSERT INTO tbl_care
			...
			VALUES
		('care_0', 'replace the straw', 1), /*SINCE CARE IS CHARACTERS YOU HAVE TO SPECIFY THE NUMBER*/
		...
		('care_5', 'move subject to excersise pen', 3),
	...
	INSERT INTO tbl_specialist
		...
		INSERT INTO tbl_species 
			/*select the feilds you created then your values.*/
